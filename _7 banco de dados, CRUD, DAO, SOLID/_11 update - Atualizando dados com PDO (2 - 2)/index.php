...
<table border="1" width="100%">
    ...
    <!-- Usando os dois posntos vc pode fechar a tag php aqui e reabir ela mais embaixo para finalizar o foreach e dessa forma podemos colocar codigo html aqui no meio para facilitar a visualização dos dados  -->
        <tr>
